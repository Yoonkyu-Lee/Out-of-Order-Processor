...
if {[getenv_compat OOOCPU_MIN_POWER ECE411_MIN_POWER] eq "1"} {
...
set_host_options -max_cores [getenv_compat OOOCPU_DC_CORES ECE411_DC_CORES]
...
eval [getenv_compat OOOCPU_COMPILE_CMD ECE411_COMPILE_CMD]
for {set i 0} {$i < [getenv_compat OOOCPU_COMPILE_ITER ECE411_COMPILE_ITER]} {incr i} {
    eval [getenv_compat OOOCPU_COMPILE_CMD_INC ECE411_COMPILE_CMD_INC]
}
